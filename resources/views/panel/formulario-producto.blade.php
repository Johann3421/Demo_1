...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow-lg">
            <div class="card-body">
                <form
                    action="{{ isset($producto) ? route('panel.productos.actualizar', $producto->id) : route('panel.productos.guardar') }}"
                    ...
                    <div class="row row-cols-md-2 g-4">
                        ...
                        <div class="col text-center">
                            ...
                            <div id="drop-zone" class="border rounded p-4 bg-light text-center cursor-pointer">
                                ...
                                <input type="file" name="imagen_url" id="imagen_url" class="form-control d-none"
                                    accept="image/*">
                                <img id="vista_previa"
                        ...
                        <div class="col">
                            ...
                            <input type="number" step="0.01" name="precio_dolares" id="precio_dolares"
                                class="form-control" value="{{ old('precio_dolares', $producto->precio_dolares ?? '') }}"
                                required>
                        </div>
                        <div class="col">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i
                                class="fas fa-save me-2"></i>{{ isset($producto) ? 'Actualizar Producto' : 'Crear Producto' }}
                        </button>
                    </div>
                </form>
            </div>
